...
# working with distibutions, feel free to ask your TA for clarification)
  #This distribution has a great standard deviation. 
...
# more attention to detail later in the course)
  ...
  attendess_distribution <- boxplot(protests$Attendees, 
                                    data = protests$Attendees,
                                    meann = "Attendees", horizontal = TRUE,
...
# (note, you will see a warning in the console, which is expected)
  ...
  par(mar=rep(2, 4))
  log_attendees_distribution <- boxplot(log_attendees, data = log_attendees,
                                        mean = "log of the attendees",
                                        horizontal = TRUE, axis = TRUE, 
                                        outline = FALSE)
# Part 3: Locations -------------------------------------------------------
...
# surprise you? Why or why not?
  #It did not surprise me because they are the same. 
